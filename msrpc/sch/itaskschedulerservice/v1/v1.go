...
type EnumInstancesRequest struct {
	...
	//	+--------------------+---------------------------------------------------------------+
	//
	// The client MUST set undefined bits to 0. The server MUST return an error if any of
	// the undefined bits are not set to 0.
	Flags uint32 `idl:"name:flags" json:"flags"`
}
...
type RunRequest struct {
	...
	//	+--------------------------------+----------------------------------------------------------------------------------+
	//
	// Undefined bits MUST be set to 0 when sent and the server MUST return an error if
	// undefined bits are set to 1.
	Flags uint32 `idl:"name:flags" json:"flags"`
