...
type SetInfoRequest struct {
	...
	//
	// The ErrorParameter value corresponds to the member of the WKSTA_INFO structure (section
	// 2.2.4.1) specified by the WkstaInfo parameter, which caused the ERROR_INVALID_PARAMETER
	// error.
	ErrorParameter uint32 `idl:"name:ErrorParameter;pointer:unique" json:"error_parameter"`
}
...
type UserEnumRequest struct {
	...
	//
	// If this parameter is NULL or points to zero, the enumeration MUST start from the
	// beginning of the list of currently logged-on users.
	Resume uint32 `idl:"name:ResumeHandle;pointer:unique" json:"resume"`
}
...
type TransportEnumRequest struct {
	...
	//
	// If this parameter is NULL or points to zero, the enumeration MUST start from the
	// beginning of the list of currently enabled transport protocols.
	Resume uint32 `idl:"name:ResumeHandle;pointer:unique" json:"resume"`
}
...
type JoinDomain2Request struct {
	...
	// qualified domain name (FQDN) (2) of the domain. If the MachineName is passed, it
