...
var (
	// Syntax UUID
	InterfaceSyntaxUUID = &uuid.UUID{TimeLow: 0x1a927394, TimeMid: 0x352e, TimeHiAndVersion: 0x4553, ClockSeqHiAndReserved: 0xae, ClockSeqLow: 0x3f, Node: [6]uint8{0x7c, 0xf4, 0xaa, 0xfc, 0xa6, 0x20}}
	// Syntax ID
	InterfaceSyntaxV1_0 = &dcerpc.SyntaxID{IfUUID: InterfaceSyntaxUUID, IfVersionMajor: 1, IfVersionMinor: 0}
)

// WdsRpcInterface interface.
...
func (o *xxx_DefaultInterfaceClient) Message(ctx context.Context, in *MessageRequest, opts ...dcerpc.CallOption) (*MessageResponse, error) {
...
func NewInterfaceClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (InterfaceClient, error) {
	cc, err := cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(InterfaceSyntaxV1_0))...)
	if err != nil {
		return nil, err
	}
...
func (o *xxx_MessageOperation) OpName() string { return "/WdsRpcInterface/v1/WdsRpcMessage" }
...
// OpName returns the operation name of WdsRpcMessage operation.
func (o *MessageRequest) OpName() string { return "/WdsRpcInterface/v1/WdsRpcMessage" }
