...
type ReceiveMessageExRequest struct {
	...
	// retrieval of a message, the server MUST return the appropriate message property value
	// into each non-NULL field. See section 2.2.3.2 for definitions of these fields:
	//
	// * ptb.old.pClass
	//
	// * ptb.old.ppMessageID
