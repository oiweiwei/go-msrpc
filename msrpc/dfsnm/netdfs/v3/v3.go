...
type AddRequest struct {
	...
	//	+-------------------------------+----------------------------------------------------------------------------------+
	//
	// If a Flags value other than the bitwise-OR of the above values is provided, the server
	// MUST return ERROR_INVALID_PARAMETER (0x00000057).
	Flags uint32 `idl:"name:Flags" json:"flags"`
}
...
type SetInfoRequest struct {
	...
	//	+----------------------+----------------------------------------------------------------------------------+
	//
	// The server MUST support Level values 100 and 101. The server SHOULD support Level
	// values 102-107 and 150. If the server does not support the provided Level, it MUST
	// fail the call.<54> The server SHOULD return error code ERROR_INVALID_PARAMETER for
	// unsupported level values.<55>
	Level uint32 `idl:"name:Level" json:"level"`
...
type GetInfoRequest struct {
	...
	//	+----------------------+----------------------------------------------------------------------------------+
	//
	// The server MUST support Level values 1-3 and 100. The server SHOULD support Level
	// values 4-9, 50 and 150. If the server does not support the provided Level, it MUST
	// fail the call.<59> The server SHOULD return error code ERROR_INVALID_PARAMETER for
	// unsupported Level values.<60>
	Level uint32 `idl:"name:Level" json:"level"`
}
...
type EnumRequest struct {
	...
	//	+--------------------+----------------------------------------------------------------------------------+
	//
	// The server MUST support Level values 1, 2 and 3. The server SHOULD support Level
	// values 5, 6, 8, 9, and 300. The server on a DC SHOULD support Level value 200. If
	// the server does not support the provided Level, it MUST fail the call.<62> The server
	// SHOULD return error code ERROR_INVALID_PARAMETER for unsupported Level values.<63>
	Level uint32 `idl:"name:Level" json:"level"`
...
type MoveRequest struct {
	...
	//	+--------------------------------------------+----------------------------------------------------------------------------------+
	//
	// All other bits are reserved and MUST NOT be used. If reserved bits are specified,
	// the server SHOULD fail the call with ERROR_INVALID_PARAMETER (0x00000057) .
	Flags uint32 `idl:"name:Flags" json:"flags"`
}
...
type RemoveFTRootRequest struct {
	...
	//
	// All other bits are reserved and MUST NOT be used. If reserved bits are specified,
	// the server SHOULD<113> fail the call.
	Flags uint32 `idl:"name:ApiFlags" json:"flags"`
	// ppRootList: On success, returns a list of DFS root targets in the domain-based DFS
...
type AddStdRootForcedRequest struct {
	...
	// <X>:\<path>
	//
	// where <X> is a drive letter (a single character from A to Z) and <path> is a file
	// system path whose leaf component is a directory.
	Share string `idl:"name:Share;string" json:"share"`
}
...
type SetDCAddressRequest struct {
	...
	//
	// All other bits are reserved and MUST NOT be used. If reserved bits are specified,
	// the server MAY fail the call with an implementation-defined failure value.<133>
	Flags uint32 `idl:"name:Flags" json:"flags"`
}
...
type EnumExRequest struct {
	...
	//
	// The server MUST support Level values 1, 2 and 3. The server SHOULD support Level
	// values 5, 6, 8, 9, and 300. The server on a DC SHOULD support Level value 200.<94>
	// If the server does not support the provided Level, it MUST fail the call. The server
	// SHOULD return error code ERROR_INVALID_PARAMETER for unsupported Level values.<95>
	Level uint32 `idl:"name:Level" json:"level"`
	// PrefMaxLen: This parameter specifies restrictions on the number of elements returned.
	// A value of 0xFFFFFFFF means there are no restrictions, in which case all entries
	// MUST be returned.<96>
...
type SetInfo2Request struct {
	...
	// The server MUST support Level values 100 and 101. The server SHOULD support Level
	// values 102-107 and 150. If the server does not support the provided Level, it MUST
	// fail the call.<102> The server SHOULD return error code ERROR_INVALID_PARAMETER for
	// unsupported Level values.<103>
	Level uint32 `idl:"name:Level" json:"level"`
...
type RemoveRootTargetRequest struct {
	...
	//
	// All other bits are reserved and MUST NOT be used. If reserved bits are specified,
	// the server SHOULD fail the call with an implementation-dependent failure value.<75>
	Flags uint32 `idl:"name:Flags" json:"flags"`
}
