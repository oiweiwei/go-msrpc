...
type RecordAction struct {
	...
	//
	// If the NetBIOS name contains fewer than 16 characters, space characters MUST be used
	// to pad the name string up to the NetBIOS suffix, which occupies the 16th character
	// position.
