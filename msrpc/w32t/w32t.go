...
type NTPClientProviderConfigData struct {
	...
	//
	// Note  "Bitwise Flags #1" is applied to "Time Source #1", and "Bitwise Flags #2" is
	// applied to "Time Source #2". Each time source listed MUST be unique. There are no
	// uniqueness constraints on how many times a given "Bitwise Flag" can appear in a list
	// of time sources.
