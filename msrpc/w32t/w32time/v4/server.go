...
type W32TimeServer interface {
	...
	//	+--------------------------------------+----------------------------------------------------------------------------------+
	//
	// The time service MUST immediately attempt to synchronize time with its time sources,
	// as specified by the flags provided in the method invocation. For more information
	// on the flags, see the ulFlags table in this section.<37>
	...
	//	+----------------------------------+----------------------------------------------------------------------------------+
	//
	// The time service MUST construct a return value that comprises a logical OR of the
	// previously specified flags. In the return value, the bit corresponding to the DS_TIMESERV_FLAG
	// MUST be set to the value of the time service's IsTimeServer data element, and the
	// bit corresponding to the DS_GOOD_TIMESERV_FLAG MUST be set to the value of the time
	// service's IsReliableTimeServer data element.<38>
