...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IAppHostPropertyCollection/v0/Count" }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IAppHostPropertyCollection/v0/Item" }
