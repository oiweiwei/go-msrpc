...
var (
	// IEnumCERTVIEWCOLUMN interface identifier 9c735be2-57a5-11d1-9bdb-00c04fb683fa
	EnumCertViewColumnIID = &dcom.IID{Data1: 0x9c735be2, Data2: 0x57a5, Data3: 0x11d1, Data4: []byte{0x9b, 0xdb, 0x00, 0xc0, 0x4f, 0xb6, 0x83, 0xfa}}
	// Syntax UUID
	EnumCertViewColumnSyntaxUUID = &uuid.UUID{TimeLow: 0x9c735be2, TimeMid: 0x57a5, TimeHiAndVersion: 0x11d1, ClockSeqHiAndReserved: 0x9b, ClockSeqLow: 0xdb, Node: [6]uint8{0x0, 0xc0, 0x4f, 0xb6, 0x83, 0xfa}}
	// Syntax ID
	EnumCertViewColumnSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: EnumCertViewColumnSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IEnumCERTVIEWCOLUMN interface.
type EnumCertViewColumnClient interface {
	...
	// IsIndexed operation.
	IsIndexed(context.Context, *IsIndexedRequest, ...dcerpc.CallOption) (*IsIndexedResponse, error)

	// GetMaxLength operation.
	GetMaxLength(context.Context, *GetMaxLengthRequest, ...dcerpc.CallOption) (*GetMaxLengthResponse, error)
	...
	IPID(context.Context, *dcom.IPID) EnumCertViewColumnClient
}

type xxx_DefaultEnumCertViewColumnClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultEnumCertViewColumnClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultEnumCertViewColumnClient) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
...
func (o *xxx_DefaultEnumCertViewColumnClient) GetName(ctx context.Context, in *GetNameRequest, opts ...dcerpc.CallOption) (*GetNameResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) GetDisplayName(ctx context.Context, in *GetDisplayNameRequest, opts ...dcerpc.CallOption) (*GetDisplayNameResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) GetType(ctx context.Context, in *GetTypeRequest, opts ...dcerpc.CallOption) (*GetTypeResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) IsIndexed(ctx context.Context, in *IsIndexedRequest, opts ...dcerpc.CallOption) (*IsIndexedResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) GetMaxLength(ctx context.Context, in *GetMaxLengthRequest, opts ...dcerpc.CallOption) (*GetMaxLengthResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) GetValue(ctx context.Context, in *GetValueRequest, opts ...dcerpc.CallOption) (*GetValueResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) Skip(ctx context.Context, in *SkipRequest, opts ...dcerpc.CallOption) (*SkipResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) Clone(ctx context.Context, in *CloneRequest, opts ...dcerpc.CallOption) (*CloneResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumCertViewColumnClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultEnumCertViewColumnClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultEnumCertViewColumnClient) IPID(ctx context.Context, ipid *dcom.IPID) EnumCertViewColumnClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultEnumCertViewColumnClient{
...
func NewEnumCertViewColumnClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (EnumCertViewColumnClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(EnumCertViewColumnSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/Next" }
...
func (o *xxx_GetNameOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/GetName" }
...
func (o *xxx_GetDisplayNameOperation) OpNum() int { return 9 }

func (o *xxx_GetDisplayNameOperation) OpName() string {
	return "/IEnumCERTVIEWCOLUMN/v0/GetDisplayName"
}
...
// xxx_GetTypeOperation structure represents the GetType operation
type xxx_GetTypeOperation struct {
	This   *dcom.ORPCThis `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat `idl:"name:That" json:"that"`
	Type   int32          `idl:"name:pType" json:"type"`
	Return int32          `idl:"name:Return" json:"return"`
}

func (o *xxx_GetTypeOperation) OpNum() int { return 10 }

func (o *xxx_GetTypeOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/GetType" }
...
func (o *xxx_GetTypeOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// pType {out, retval} (1:{pointer=ref}*(1))(2:{alias=LONG}(int32))
	{
...
// GetTypeRequest structure represents the GetType operation request
...
// GetTypeResponse structure represents the GetType operation response
type GetTypeResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That *dcom.ORPCThat `idl:"name:That" json:"that"`
	Type int32          `idl:"name:pType" json:"type"`
	// Return: The GetType return value.
	Return int32 `idl:"name:Return" json:"return"`
}
...
// xxx_IsIndexedOperation structure represents the IsIndexed operation
type xxx_IsIndexedOperation struct {
	This    *dcom.ORPCThis `idl:"name:This" json:"this"`
	That    *dcom.ORPCThat `idl:"name:That" json:"that"`
	Indexed int32          `idl:"name:pIndexed" json:"indexed"`
	Return  int32          `idl:"name:Return" json:"return"`
}

func (o *xxx_IsIndexedOperation) OpNum() int { return 11 }

func (o *xxx_IsIndexedOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/IsIndexed" }

func (o *xxx_IsIndexedOperation) xxx_PrepareRequestPayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareRequestPayload(context.Context) error }); ok {
		if err := hook.AfterPrepareRequestPayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_IsIndexedOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_IsIndexedOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_IsIndexedOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_IsIndexedOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// pIndexed {out, retval} (1:{pointer=ref}*(1))(2:{alias=LONG}(int32))
	{
		if err := w.WriteData(o.Indexed); err != nil {
			return err
		}
	}
	// Return {out} (1:{alias=HRESULT, names=LONG}(int32))
...
func (o *xxx_IsIndexedOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
	...
	// pIndexed {out, retval} (1:{pointer=ref}*(1))(2:{alias=LONG}(int32))
	{
		if err := w.ReadData(&o.Indexed); err != nil {
			return err
		}
	}
	// Return {out} (1:{alias=HRESULT, names=LONG}(int32))
...
// IsIndexedRequest structure represents the IsIndexed operation request
type IsIndexedRequest struct {
	// This: ORPCTHIS structure that is used to send ORPC extension data to the server.
	This *dcom.ORPCThis `idl:"name:This" json:"this"`
}

func (o *IsIndexedRequest) xxx_ToOp(ctx context.Context, op *xxx_IsIndexedOperation) *xxx_IsIndexedOperation {
	if op == nil {
...
func (o *IsIndexedRequest) xxx_FromOp(ctx context.Context, op *xxx_IsIndexedOperation) {
	if o == nil {
		return
	}
	o.This = op.This
}
func (o *IsIndexedRequest) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRRequest(ctx, w)
}
func (o *IsIndexedRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_IsIndexedOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
// IsIndexedResponse structure represents the IsIndexed operation response
type IsIndexedResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That    *dcom.ORPCThat `idl:"name:That" json:"that"`
	Indexed int32          `idl:"name:pIndexed" json:"indexed"`
	// Return: The IsIndexed return value.
	Return int32 `idl:"name:Return" json:"return"`
}

func (o *IsIndexedResponse) xxx_ToOp(ctx context.Context, op *xxx_IsIndexedOperation) *xxx_IsIndexedOperation {
	if op == nil {
		op = &xxx_IsIndexedOperation{}
	}
	if o == nil {
	...
	op.That = o.That
	op.Indexed = o.Indexed
	op.Return = o.Return
	return op
}

func (o *IsIndexedResponse) xxx_FromOp(ctx context.Context, op *xxx_IsIndexedOperation) {
	if o == nil {
		return
	}
	o.That = op.That
	o.Indexed = op.Indexed
	o.Return = op.Return
}
func (o *IsIndexedResponse) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRResponse(ctx, w)
}
func (o *IsIndexedResponse) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_IsIndexedOperation{}
	if err := _o.UnmarshalNDRResponse(ctx, r); err != nil {
		return err
	}
...
// xxx_GetMaxLengthOperation structure represents the GetMaxLength operation
type xxx_GetMaxLengthOperation struct {
	This      *dcom.ORPCThis `idl:"name:This" json:"this"`
	That      *dcom.ORPCThat `idl:"name:That" json:"that"`
	MaxLength int32          `idl:"name:pMaxLength" json:"max_length"`
	Return    int32          `idl:"name:Return" json:"return"`
}

func (o *xxx_GetMaxLengthOperation) OpNum() int { return 12 }

func (o *xxx_GetMaxLengthOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/GetMaxLength" }

func (o *xxx_GetMaxLengthOperation) xxx_PrepareRequestPayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareRequestPayload(context.Context) error }); ok {
		if err := hook.AfterPrepareRequestPayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetMaxLengthOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_GetMaxLengthOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_GetMaxLengthOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetMaxLengthOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// pMaxLength {out, retval} (1:{pointer=ref}*(1))(2:{alias=LONG}(int32))
	{
...
func (o *xxx_GetMaxLengthOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
...
// GetMaxLengthRequest structure represents the GetMaxLength operation request
type GetMaxLengthRequest struct {
	// This: ORPCTHIS structure that is used to send ORPC extension data to the server.
	This *dcom.ORPCThis `idl:"name:This" json:"this"`
}

func (o *GetMaxLengthRequest) xxx_ToOp(ctx context.Context, op *xxx_GetMaxLengthOperation) *xxx_GetMaxLengthOperation {
	if op == nil {
...
func (o *GetMaxLengthRequest) xxx_FromOp(ctx context.Context, op *xxx_GetMaxLengthOperation) {
	if o == nil {
		return
	}
	o.This = op.This
}
func (o *GetMaxLengthRequest) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRRequest(ctx, w)
}
func (o *GetMaxLengthRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetMaxLengthOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
// GetMaxLengthResponse structure represents the GetMaxLength operation response
type GetMaxLengthResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That      *dcom.ORPCThat `idl:"name:That" json:"that"`
	MaxLength int32          `idl:"name:pMaxLength" json:"max_length"`
	// Return: The GetMaxLength return value.
	Return int32 `idl:"name:Return" json:"return"`
}

func (o *GetMaxLengthResponse) xxx_ToOp(ctx context.Context, op *xxx_GetMaxLengthOperation) *xxx_GetMaxLengthOperation {
	if op == nil {
		op = &xxx_GetMaxLengthOperation{}
	}
	if o == nil {
	...
	op.That = o.That
	op.MaxLength = o.MaxLength
	op.Return = o.Return
	return op
}

func (o *GetMaxLengthResponse) xxx_FromOp(ctx context.Context, op *xxx_GetMaxLengthOperation) {
	if o == nil {
		return
	}
	o.That = op.That
	o.MaxLength = op.MaxLength
	o.Return = op.Return
}
func (o *GetMaxLengthResponse) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRResponse(ctx, w)
}
func (o *GetMaxLengthResponse) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetMaxLengthOperation{}
	if err := _o.UnmarshalNDRResponse(ctx, r); err != nil {
		return err
	}
...
func (o *xxx_GetValueOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/GetValue" }
...
func (o *xxx_SkipOperation) OpNum() int { return 14 }

func (o *xxx_SkipOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/Skip" }
...
func (o *xxx_ResetOperation) OpNum() int { return 15 }

func (o *xxx_ResetOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/Reset" }
...
func (o *xxx_CloneOperation) OpNum() int { return 16 }

func (o *xxx_CloneOperation) OpName() string { return "/IEnumCERTVIEWCOLUMN/v0/Clone" }
