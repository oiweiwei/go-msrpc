...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IFolderActionCollection/v0/Count" }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IFolderActionCollection/v0/Item" }
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IFolderActionCollection/v0/_NewEnum" }
...
// OpName returns the operation name of Add operation.
func (o *AddRequest) OpName() string { return "/IFolderActionCollection/v0/Add" }
...
// OpName returns the operation name of Remove operation.
func (o *RemoveRequest) OpName() string { return "/IFolderActionCollection/v0/Remove" }
...
// OpName returns the operation name of Clear operation.
func (o *ClearRequest) OpName() string { return "/IFolderActionCollection/v0/Clear" }
...
// OpName returns the operation name of AddRange operation.
func (o *AddRangeRequest) OpName() string { return "/IFolderActionCollection/v0/AddRange" }
...
// OpNum returns the operation number of CreateFolderAction operation.
func (o *xxx_CreateFolderActionOperation) OpNum() int { return 14 }

// OpName returns the operation name of CreateFolderAction operation.
...
// MakeCreateFolderActionRequest build a response structure from the given request structure.
func (o *CreateFolderActionRequest) MakeResponse() *CreateFolderActionResponse {
	return &CreateFolderActionResponse{}
}

// OpNum returns the operation number of CreateFolderAction operation.
func (o *CreateFolderActionRequest) OpNum() int { return 14 }

// OpName returns the operation name of CreateFolderAction operation.
func (o *CreateFolderActionRequest) OpName() string {
	return "/IFolderActionCollection/v0/CreateFolderAction"
}
