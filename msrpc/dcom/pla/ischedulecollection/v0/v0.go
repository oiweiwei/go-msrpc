...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IScheduleCollection/v0/Count" }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IScheduleCollection/v0/Item" }
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IScheduleCollection/v0/_NewEnum" }
...
// OpName returns the operation name of Add operation.
func (o *AddRequest) OpName() string { return "/IScheduleCollection/v0/Add" }
...
// OpName returns the operation name of Remove operation.
func (o *RemoveRequest) OpName() string { return "/IScheduleCollection/v0/Remove" }
...
// OpName returns the operation name of Clear operation.
func (o *ClearRequest) OpName() string { return "/IScheduleCollection/v0/Clear" }
...
// OpName returns the operation name of AddRange operation.
func (o *AddRangeRequest) OpName() string { return "/IScheduleCollection/v0/AddRange" }
...
// OpName returns the operation name of CreateSchedule operation.
func (o *CreateScheduleRequest) OpName() string { return "/IScheduleCollection/v0/CreateSchedule" }
