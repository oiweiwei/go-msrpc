...
var (
	// IUpdateServiceCollection interface identifier 9b0353aa-0e52-44ff-b8b0-1f7fa0437f88
	UpdateServiceCollectionIID = &dcom.IID{Data1: 0x9b0353aa, Data2: 0x0e52, Data3: 0x44ff, Data4: []byte{0xb8, 0xb0, 0x1f, 0x7f, 0xa0, 0x43, 0x7f, 0x88}}
	// Syntax UUID
	UpdateServiceCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0x9b0353aa, TimeMid: 0xe52, TimeHiAndVersion: 0x44ff, ClockSeqHiAndReserved: 0xb8, ClockSeqLow: 0xb0, Node: [6]uint8{0x1f, 0x7f, 0xa0, 0x43, 0x7f, 0x88}}
	// Syntax ID
	UpdateServiceCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: UpdateServiceCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IUpdateServiceCollection interface.
type UpdateServiceCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) UpdateServiceCollectionClient
}

type xxx_DefaultUpdateServiceCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultUpdateServiceCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultUpdateServiceCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultUpdateServiceCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateServiceCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateServiceCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultUpdateServiceCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultUpdateServiceCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) UpdateServiceCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultUpdateServiceCollectionClient{
...
func NewUpdateServiceCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (UpdateServiceCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(UpdateServiceCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_GetItemOperation struct {
	...
	ReturnValue *uamg.UpdateService `idl:"name:retval" json:"return_value"`
...
func (o *xxx_GetItemOperation) OpName() string { return "/IUpdateServiceCollection/v0/Item" }
...
func (o *xxx_GetItemOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateService}(interface))
	{
...
func (o *xxx_GetItemOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateService}(interface))
	{
		_ptr_retval := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.ReturnValue == nil {
				o.ReturnValue = &uamg.UpdateService{}
			}
		...
		_s_retval := func(ptr interface{}) { o.ReturnValue = *ptr.(**uamg.UpdateService) }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IUpdateServiceCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string { return "/IUpdateServiceCollection/v0/_NewEnum" }
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IUpdateServiceCollection/v0/_NewEnum" }
...
func (o *xxx_GetCountOperation) OpName() string { return "/IUpdateServiceCollection/v0/Count" }
...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IUpdateServiceCollection/v0/Count" }
