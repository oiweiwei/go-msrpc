...
var (
	// IStringCollection interface identifier eff90582-2ddc-480f-a06d-60f3fbc362c3
	StringCollectionIID = &dcom.IID{Data1: 0xeff90582, Data2: 0x2ddc, Data3: 0x480f, Data4: []byte{0xa0, 0x6d, 0x60, 0xf3, 0xfb, 0xc3, 0x62, 0xc3}}
	// Syntax UUID
	StringCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0xeff90582, TimeMid: 0x2ddc, TimeHiAndVersion: 0x480f, ClockSeqHiAndReserved: 0xa0, ClockSeqLow: 0x6d, Node: [6]uint8{0x60, 0xf3, 0xfb, 0xc3, 0x62, 0xc3}}
	// Syntax ID
	StringCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: StringCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IStringCollection interface.
type StringCollectionClient interface {
	...
	Copy(context.Context, *CopyRequest, ...dcerpc.CallOption) (*CopyResponse, error)
	...
	// If the collection is read-only, the server SHOULD return WU_E_NOT_SUPPORTED (0x80240037).
	//
	// If the index is less than 0x00000000 or greater than the number of items in the collection,
	// the server SHOULD return WU_E_INVALIDINDEX (0x80240007). The server MUST allow insertion
	...
	IPID(context.Context, *dcom.IPID) StringCollectionClient
}

type xxx_DefaultStringCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultStringCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultStringCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultStringCollectionClient) SetItem(ctx context.Context, in *SetItemRequest, opts ...dcerpc.CallOption) (*SetItemResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) GetReadOnly(ctx context.Context, in *GetReadOnlyRequest, opts ...dcerpc.CallOption) (*GetReadOnlyResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) Add(ctx context.Context, in *AddRequest, opts ...dcerpc.CallOption) (*AddResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) Clear(ctx context.Context, in *ClearRequest, opts ...dcerpc.CallOption) (*ClearResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) Copy(ctx context.Context, in *CopyRequest, opts ...dcerpc.CallOption) (*CopyResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) Insert(ctx context.Context, in *InsertRequest, opts ...dcerpc.CallOption) (*InsertResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) RemoveAT(ctx context.Context, in *RemoveATRequest, opts ...dcerpc.CallOption) (*RemoveATResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultStringCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultStringCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultStringCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) StringCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultStringCollectionClient{
...
func NewStringCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (StringCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(StringCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetItemOperation) OpName() string { return "/IStringCollection/v0/Item" }
...
// OpNum returns the operation number of Item operation.
func (o *GetItemRequest) OpNum() int { return 7 }

// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IStringCollection/v0/Item" }
...
// OpName returns the operation name of Item operation.
func (o *xxx_SetItemOperation) OpName() string { return "/IStringCollection/v0/Item" }
...
// MakeSetItemRequest build a response structure from the given request structure.
func (o *SetItemRequest) MakeResponse() *SetItemResponse {
	return &SetItemResponse{}
}

// OpNum returns the operation number of Item operation.
func (o *SetItemRequest) OpNum() int { return 8 }

// OpName returns the operation name of Item operation.
func (o *SetItemRequest) OpName() string { return "/IStringCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string { return "/IStringCollection/v0/_NewEnum" }
...
// MakeGet_NewEnumRequest build a response structure from the given request structure.
func (o *Get_NewEnumRequest) MakeResponse() *Get_NewEnumResponse {
	return &Get_NewEnumResponse{}
}

// OpNum returns the operation number of _NewEnum operation.
func (o *Get_NewEnumRequest) OpNum() int { return 9 }

// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IStringCollection/v0/_NewEnum" }

// Get_NewEnumResponse structure represents the _NewEnum operation response
type Get_NewEnumResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That *dcom.ORPCThat `idl:"name:That" json:"that"`
	// retval: The IUnknown interface of an object that implements the IEnumVARIANT interface,
	// which can be used to enumerate the elements in the collection.
	//
	// retval: The IUnknown interface of an object that also implements the IEnumVARIANT
	// interface, which can be used to enumerate the elements in the collection.
	//
	// retval: The IUnknown interface of an object that also implements the IEnumVARIANT
	// interface, which can be used to enumerate the elements in the collection.
	//
...
func (o *xxx_GetCountOperation) OpName() string { return "/IStringCollection/v0/Count" }
...
// OpNum returns the operation number of Count operation.
func (o *GetCountRequest) OpNum() int { return 10 }

// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IStringCollection/v0/Count" }
...
func (o *xxx_GetReadOnlyOperation) OpName() string { return "/IStringCollection/v0/ReadOnly" }
...
// OpNum returns the operation number of ReadOnly operation.
func (o *GetReadOnlyRequest) OpNum() int { return 11 }

// OpName returns the operation name of ReadOnly operation.
func (o *GetReadOnlyRequest) OpName() string { return "/IStringCollection/v0/ReadOnly" }
...
func (o *xxx_AddOperation) OpName() string { return "/IStringCollection/v0/Add" }
...
// OpNum returns the operation number of Add operation.
func (o *AddRequest) OpNum() int { return 12 }

// OpName returns the operation name of Add operation.
func (o *AddRequest) OpName() string { return "/IStringCollection/v0/Add" }
...
// OpNum returns the operation number of Clear operation.
func (o *xxx_ClearOperation) OpNum() int { return 13 }

// OpName returns the operation name of Clear operation.
func (o *xxx_ClearOperation) OpName() string { return "/IStringCollection/v0/Clear" }
...
// MakeClearRequest build a response structure from the given request structure.
func (o *ClearRequest) MakeResponse() *ClearResponse {
	return &ClearResponse{}
}

// OpNum returns the operation number of Clear operation.
func (o *ClearRequest) OpNum() int { return 13 }

// OpName returns the operation name of Clear operation.
func (o *ClearRequest) OpName() string { return "/IStringCollection/v0/Clear" }
...
// xxx_CopyOperation structure represents the Copy operation
type xxx_CopyOperation struct {
	This        *dcom.ORPCThis         `idl:"name:This" json:"this"`
	That        *dcom.ORPCThat         `idl:"name:That" json:"that"`
...
// OpNum returns the operation number of Copy operation.
func (o *xxx_CopyOperation) OpNum() int { return 14 }

// OpName returns the operation name of Copy operation.
func (o *xxx_CopyOperation) OpName() string { return "/IStringCollection/v0/Copy" }

func (o *xxx_CopyOperation) xxx_PrepareRequestPayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareRequestPayload(context.Context) error }); ok {
		if err := hook.AfterPrepareRequestPayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_CopyOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_CopyOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_CopyOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_CopyOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
...
func (o *xxx_CopyOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
...
// CopyRequest structure represents the Copy operation request
type CopyRequest struct {
	// This: ORPCTHIS structure that is used to send ORPC extension data to the server.
	This *dcom.ORPCThis `idl:"name:This" json:"this"`
}

func (o *CopyRequest) xxx_ToOp(ctx context.Context, op *xxx_CopyOperation) *xxx_CopyOperation {
	if op == nil {
...
func (o *CopyRequest) xxx_FromOp(ctx context.Context, op *xxx_CopyOperation) {
	if o == nil {
		return
	}
	o.This = op.This
}
func (o *CopyRequest) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRRequest(ctx, w)
}
func (o *CopyRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_CopyOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
// MakeCopyRequest build a response structure from the given request structure.
func (o *CopyRequest) MakeResponse() *CopyResponse {
	return &CopyResponse{}
}

// OpNum returns the operation number of Copy operation.
func (o *CopyRequest) OpNum() int { return 14 }

// OpName returns the operation name of Copy operation.
func (o *CopyRequest) OpName() string { return "/IStringCollection/v0/Copy" }

// CopyResponse structure represents the Copy operation response
type CopyResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That *dcom.ORPCThat `idl:"name:That" json:"that"`
	// retval: A read-write IStringCollection (section 3.18.4) instance containing a copy
	// of the strings in this collection, in the same order.
	ReturnValue *uamg.StringCollection `idl:"name:retval" json:"return_value"`
	// Return: The Copy return value.
	Return int32 `idl:"name:Return" json:"return"`
}

func (o *CopyResponse) xxx_ToOp(ctx context.Context, op *xxx_CopyOperation) *xxx_CopyOperation {
	if op == nil {
		op = &xxx_CopyOperation{}
	}
	if o == nil {
...
func (o *CopyResponse) xxx_FromOp(ctx context.Context, op *xxx_CopyOperation) {
	if o == nil {
		return
	}
	o.That = op.That
...
func (o *CopyResponse) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRResponse(ctx, w)
}
func (o *CopyResponse) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_CopyOperation{}
	if err := _o.UnmarshalNDRResponse(ctx, r); err != nil {
		return err
	}
...
func (o *xxx_InsertOperation) OpName() string { return "/IStringCollection/v0/Insert" }
...
// OpNum returns the operation number of Insert operation.
func (o *InsertRequest) OpNum() int { return 15 }

// OpName returns the operation name of Insert operation.
func (o *InsertRequest) OpName() string { return "/IStringCollection/v0/Insert" }
...
// OpNum returns the operation number of RemoveAt operation.
func (o *xxx_RemoveATOperation) OpNum() int { return 16 }

// OpName returns the operation name of RemoveAt operation.
func (o *xxx_RemoveATOperation) OpName() string { return "/IStringCollection/v0/RemoveAt" }
...
// MakeRemoveATRequest build a response structure from the given request structure.
func (o *RemoveATRequest) MakeResponse() *RemoveATResponse {
	return &RemoveATResponse{}
}

// OpNum returns the operation number of RemoveAt operation.
func (o *RemoveATRequest) OpNum() int { return 16 }

// OpName returns the operation name of RemoveAt operation.
func (o *RemoveATRequest) OpName() string { return "/IStringCollection/v0/RemoveAt" }
