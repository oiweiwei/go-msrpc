...
// OpNum returns the operation number of AutoSelection operation.
func (o *GetAutoSelectionRequest) OpNum() int { return 67 }

// OpName returns the operation name of AutoSelection operation.
func (o *GetAutoSelectionRequest) OpName() string { return "/IWindowsDriverUpdate5/v0/AutoSelection" }
...
// OpNum returns the operation number of AutoDownload operation.
func (o *GetAutoDownloadRequest) OpNum() int { return 68 }

// OpName returns the operation name of AutoDownload operation.
func (o *GetAutoDownloadRequest) OpName() string { return "/IWindowsDriverUpdate5/v0/AutoDownload" }
