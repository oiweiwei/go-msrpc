...
// OpNum returns the operation number of RebootRequired operation.
func (o *GetRebootRequiredRequest) OpNum() int { return 52 }

// OpName returns the operation name of RebootRequired operation.
func (o *GetRebootRequiredRequest) OpName() string { return "/IUpdate2/v0/RebootRequired" }
...
// OpNum returns the operation number of IsPresent operation.
func (o *GetIsPresentRequest) OpNum() int { return 53 }

// OpName returns the operation name of IsPresent operation.
func (o *GetIsPresentRequest) OpName() string { return "/IUpdate2/v0/IsPresent" }
...
// OpNum returns the operation number of CveIDs operation.
func (o *GetCveIDsRequest) OpNum() int { return 54 }

// OpName returns the operation name of CveIDs operation.
func (o *GetCveIDsRequest) OpName() string { return "/IUpdate2/v0/CveIDs" }
