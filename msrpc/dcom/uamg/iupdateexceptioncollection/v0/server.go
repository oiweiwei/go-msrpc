...
// IUpdateExceptionCollection server interface.
type UpdateExceptionCollectionServer interface {
...
func RegisterUpdateExceptionCollectionServer(conn dcerpc.Conn, o UpdateExceptionCollectionServer, opts ...dcerpc.Option) {
	conn.RegisterServer(NewUpdateExceptionCollectionServerHandle(o), append(opts, dcerpc.WithAbstractSyntax(UpdateExceptionCollectionSyntaxV0_0))...)
}

func NewUpdateExceptionCollectionServerHandle(o UpdateExceptionCollectionServer) dcerpc.ServerHandle {
	return func(ctx context.Context, opNum int, r ndr.Reader) (dcerpc.Operation, error) {
		return UpdateExceptionCollectionServerHandle(ctx, o, opNum, r)
	}
}

func UpdateExceptionCollectionServerHandle(ctx context.Context, o UpdateExceptionCollectionServer, opNum int, r ndr.Reader) (dcerpc.Operation, error) {
	if opNum < 7 {
...
// Unimplemented IUpdateExceptionCollection
type UnimplementedUpdateExceptionCollectionServer struct {
	idispatch.UnimplementedDispatchServer
}

func (UnimplementedUpdateExceptionCollectionServer) GetItem(context.Context, *GetItemRequest) (*GetItemResponse, error) {
	return nil, dcerpc.ErrNotImplemented
}
func (UnimplementedUpdateExceptionCollectionServer) Get_NewEnum(context.Context, *Get_NewEnumRequest) (*Get_NewEnumResponse, error) {
	return nil, dcerpc.ErrNotImplemented
}
func (UnimplementedUpdateExceptionCollectionServer) GetCount(context.Context, *GetCountRequest) (*GetCountResponse, error) {
	return nil, dcerpc.ErrNotImplemented
}

var _ UpdateExceptionCollectionServer = (*UnimplementedUpdateExceptionCollectionServer)(nil)
