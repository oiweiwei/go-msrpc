...
var (
	// IUpdateDownloadContentCollection interface identifier bc5513c8-b3b8-4bf7-a4d4-361c0d8c88ba
	UpdateDownloadContentCollectionIID = &dcom.IID{Data1: 0xbc5513c8, Data2: 0xb3b8, Data3: 0x4bf7, Data4: []byte{0xa4, 0xd4, 0x36, 0x1c, 0x0d, 0x8c, 0x88, 0xba}}
	// Syntax UUID
	UpdateDownloadContentCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0xbc5513c8, TimeMid: 0xb3b8, TimeHiAndVersion: 0x4bf7, ClockSeqHiAndReserved: 0xa4, ClockSeqLow: 0xd4, Node: [6]uint8{0x36, 0x1c, 0xd, 0x8c, 0x88, 0xba}}
	// Syntax ID
	UpdateDownloadContentCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: UpdateDownloadContentCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IUpdateDownloadContentCollection interface.
type UpdateDownloadContentCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) UpdateDownloadContentCollectionClient
}

type xxx_DefaultUpdateDownloadContentCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultUpdateDownloadContentCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultUpdateDownloadContentCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultUpdateDownloadContentCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateDownloadContentCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateDownloadContentCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultUpdateDownloadContentCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultUpdateDownloadContentCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) UpdateDownloadContentCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultUpdateDownloadContentCollectionClient{
...
func NewUpdateDownloadContentCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (UpdateDownloadContentCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(UpdateDownloadContentCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_GetItemOperation struct {
	...
	ReturnValue *uamg.UpdateDownloadContent `idl:"name:retval" json:"return_value"`
...
func (o *xxx_GetItemOperation) OpName() string { return "/IUpdateDownloadContentCollection/v0/Item" }
...
func (o *xxx_GetItemOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateDownloadContent}(interface))
	{
		if o.ReturnValue != nil {
			_ptr_retval := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.ReturnValue != nil {
					...
					if err := (&uamg.UpdateDownloadContent{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
...
func (o *xxx_GetItemOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateDownloadContent}(interface))
	{
		_ptr_retval := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.ReturnValue == nil {
				o.ReturnValue = &uamg.UpdateDownloadContent{}
			}
		...
		_s_retval := func(ptr interface{}) { o.ReturnValue = *ptr.(**uamg.UpdateDownloadContent) }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IUpdateDownloadContentCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string {
	return "/IUpdateDownloadContentCollection/v0/_NewEnum"
}
...
// OpNum returns the operation number of _NewEnum operation.
func (o *Get_NewEnumRequest) OpNum() int { return 8 }

// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IUpdateDownloadContentCollection/v0/_NewEnum" }
...
func (o *xxx_GetCountOperation) OpName() string { return "/IUpdateDownloadContentCollection/v0/Count" }
...
// OpNum returns the operation number of Count operation.
func (o *GetCountRequest) OpNum() int { return 9 }

// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IUpdateDownloadContentCollection/v0/Count" }
