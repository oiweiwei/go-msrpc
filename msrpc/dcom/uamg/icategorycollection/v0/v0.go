...
var (
	// ICategoryCollection interface identifier 3a56bfb8-576c-43f7-9335-fe4838fd7e37
	CategoryCollectionIID = &dcom.IID{Data1: 0x3a56bfb8, Data2: 0x576c, Data3: 0x43f7, Data4: []byte{0x93, 0x35, 0xfe, 0x48, 0x38, 0xfd, 0x7e, 0x37}}
	// Syntax UUID
	CategoryCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0x3a56bfb8, TimeMid: 0x576c, TimeHiAndVersion: 0x43f7, ClockSeqHiAndReserved: 0x93, ClockSeqLow: 0x35, Node: [6]uint8{0xfe, 0x48, 0x38, 0xfd, 0x7e, 0x37}}
	// Syntax ID
	CategoryCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: CategoryCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// ICategoryCollection interface.
type CategoryCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) CategoryCollectionClient
}

type xxx_DefaultCategoryCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultCategoryCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultCategoryCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultCategoryCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultCategoryCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultCategoryCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultCategoryCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultCategoryCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) CategoryCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultCategoryCollectionClient{
...
func NewCategoryCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (CategoryCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(CategoryCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetItemOperation) OpName() string { return "/ICategoryCollection/v0/Item" }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/ICategoryCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string { return "/ICategoryCollection/v0/_NewEnum" }
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/ICategoryCollection/v0/_NewEnum" }
...
func (o *xxx_GetCountOperation) OpName() string { return "/ICategoryCollection/v0/Count" }
...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/ICategoryCollection/v0/Count" }
