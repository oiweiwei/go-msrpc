...
var (
	// IUpdateHistoryEntryCollection interface identifier a7f04f3c-a290-435b-aadf-a116c3357a5c
	UpdateHistoryEntryCollectionIID = &dcom.IID{Data1: 0xa7f04f3c, Data2: 0xa290, Data3: 0x435b, Data4: []byte{0xaa, 0xdf, 0xa1, 0x16, 0xc3, 0x35, 0x7a, 0x5c}}
	// Syntax UUID
	UpdateHistoryEntryCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0xa7f04f3c, TimeMid: 0xa290, TimeHiAndVersion: 0x435b, ClockSeqHiAndReserved: 0xaa, ClockSeqLow: 0xdf, Node: [6]uint8{0xa1, 0x16, 0xc3, 0x35, 0x7a, 0x5c}}
	// Syntax ID
	UpdateHistoryEntryCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: UpdateHistoryEntryCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IUpdateHistoryEntryCollection interface.
type UpdateHistoryEntryCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) UpdateHistoryEntryCollectionClient
}

type xxx_DefaultUpdateHistoryEntryCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultUpdateHistoryEntryCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) UpdateHistoryEntryCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultUpdateHistoryEntryCollectionClient{
...
func NewUpdateHistoryEntryCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (UpdateHistoryEntryCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(UpdateHistoryEntryCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_GetItemOperation struct {
	...
	ReturnValue *uamg.UpdateHistoryEntry `idl:"name:retval" json:"return_value"`
...
func (o *xxx_GetItemOperation) OpName() string { return "/IUpdateHistoryEntryCollection/v0/Item" }
...
func (o *xxx_GetItemOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateHistoryEntry}(interface))
	{
		if o.ReturnValue != nil {
			_ptr_retval := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.ReturnValue != nil {
					...
					if err := (&uamg.UpdateHistoryEntry{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
...
func (o *xxx_GetItemOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IUpdateHistoryEntry}(interface))
	{
		_ptr_retval := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.ReturnValue == nil {
				o.ReturnValue = &uamg.UpdateHistoryEntry{}
			}
		...
		_s_retval := func(ptr interface{}) { o.ReturnValue = *ptr.(**uamg.UpdateHistoryEntry) }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IUpdateHistoryEntryCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string {
	return "/IUpdateHistoryEntryCollection/v0/_NewEnum"
}
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string { return "/IUpdateHistoryEntryCollection/v0/_NewEnum" }
...
func (o *xxx_GetCountOperation) OpName() string { return "/IUpdateHistoryEntryCollection/v0/Count" }
...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IUpdateHistoryEntryCollection/v0/Count" }
