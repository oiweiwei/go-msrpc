...
var (
	// IWindowsDriverUpdateEntry interface identifier ed8bfe40-a60b-42ea-9652-817dfcfa23ec
	WindowsDriverUpdateEntryIID = &dcom.IID{Data1: 0xed8bfe40, Data2: 0xa60b, Data3: 0x42ea, Data4: []byte{0x96, 0x52, 0x81, 0x7d, 0xfc, 0xfa, 0x23, 0xec}}
	// Syntax UUID
	WindowsDriverUpdateEntrySyntaxUUID = &uuid.UUID{TimeLow: 0xed8bfe40, TimeMid: 0xa60b, TimeHiAndVersion: 0x42ea, ClockSeqHiAndReserved: 0x96, ClockSeqLow: 0x52, Node: [6]uint8{0x81, 0x7d, 0xfc, 0xfa, 0x23, 0xec}}
	// Syntax ID
	WindowsDriverUpdateEntrySyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: WindowsDriverUpdateEntrySyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IWindowsDriverUpdateEntry interface.
type WindowsDriverUpdateEntryClient interface {
	...
	IPID(context.Context, *dcom.IPID) WindowsDriverUpdateEntryClient
}

type xxx_DefaultWindowsDriverUpdateEntryClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultWindowsDriverUpdateEntryClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverClass(ctx context.Context, in *GetDriverClassRequest, opts ...dcerpc.CallOption) (*GetDriverClassResponse, error) {
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverHardwareID(ctx context.Context, in *GetDriverHardwareIDRequest, opts ...dcerpc.CallOption) (*GetDriverHardwareIDResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverManufacturer(ctx context.Context, in *GetDriverManufacturerRequest, opts ...dcerpc.CallOption) (*GetDriverManufacturerResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverModel(ctx context.Context, in *GetDriverModelRequest, opts ...dcerpc.CallOption) (*GetDriverModelResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverProvider(ctx context.Context, in *GetDriverProviderRequest, opts ...dcerpc.CallOption) (*GetDriverProviderResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDriverVerDate(ctx context.Context, in *GetDriverVerDateRequest, opts ...dcerpc.CallOption) (*GetDriverVerDateResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDeviceProblemNumber(ctx context.Context, in *GetDeviceProblemNumberRequest, opts ...dcerpc.CallOption) (*GetDeviceProblemNumberResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) GetDeviceStatus(ctx context.Context, in *GetDeviceStatusRequest, opts ...dcerpc.CallOption) (*GetDeviceStatusResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultWindowsDriverUpdateEntryClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultWindowsDriverUpdateEntryClient) IPID(ctx context.Context, ipid *dcom.IPID) WindowsDriverUpdateEntryClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultWindowsDriverUpdateEntryClient{
...
func NewWindowsDriverUpdateEntryClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (WindowsDriverUpdateEntryClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(WindowsDriverUpdateEntrySyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetDriverClassOperation) OpNum() int { return 7 }

// OpName returns the operation name of DriverClass operation.
func (o *xxx_GetDriverClassOperation) OpName() string {
	return "/IWindowsDriverUpdateEntry/v0/DriverClass"
}
...
// OpNum returns the operation number of DriverClass operation.
func (o *GetDriverClassRequest) OpNum() int { return 7 }

// OpName returns the operation name of DriverClass operation.
func (o *GetDriverClassRequest) OpName() string { return "/IWindowsDriverUpdateEntry/v0/DriverClass" }
...
// OpNum returns the operation number of DriverHardwareID operation.
func (o *GetDriverHardwareIDRequest) OpNum() int { return 8 }
...
// OpNum returns the operation number of DriverManufacturer operation.
func (o *GetDriverManufacturerRequest) OpNum() int { return 9 }
...
func (o *xxx_GetDriverModelOperation) OpNum() int { return 10 }

// OpName returns the operation name of DriverModel operation.
func (o *xxx_GetDriverModelOperation) OpName() string {
	return "/IWindowsDriverUpdateEntry/v0/DriverModel"
}
...
// OpNum returns the operation number of DriverModel operation.
func (o *GetDriverModelRequest) OpNum() int { return 10 }

// OpName returns the operation name of DriverModel operation.
func (o *GetDriverModelRequest) OpName() string { return "/IWindowsDriverUpdateEntry/v0/DriverModel" }
...
// OpNum returns the operation number of DriverProvider operation.
func (o *GetDriverProviderRequest) OpNum() int { return 11 }

// OpName returns the operation name of DriverProvider operation.
func (o *GetDriverProviderRequest) OpName() string {
	return "/IWindowsDriverUpdateEntry/v0/DriverProvider"
}
...
// OpNum returns the operation number of DriverVerDate operation.
func (o *GetDriverVerDateRequest) OpNum() int { return 12 }

// OpName returns the operation name of DriverVerDate operation.
func (o *GetDriverVerDateRequest) OpName() string {
	return "/IWindowsDriverUpdateEntry/v0/DriverVerDate"
}
...
func (o *xxx_GetDeviceProblemNumberOperation) OpNum() int { return 13 }
...
func (o *xxx_GetDeviceProblemNumberOperation) OpName() string {
	return "/IWindowsDriverUpdateEntry/v0/DeviceProblemNumber"
}
...
// OpNum returns the operation number of DeviceProblemNumber operation.
func (o *GetDeviceProblemNumberRequest) OpNum() int { return 13 }
...
// OpNum returns the operation number of DeviceStatus operation.
func (o *GetDeviceStatusRequest) OpNum() int { return 14 }

// OpName returns the operation name of DeviceStatus operation.
func (o *GetDeviceStatusRequest) OpName() string { return "/IWindowsDriverUpdateEntry/v0/DeviceStatus" }
