...
var (
	// IWindowsDriverUpdateEntryCollection interface identifier 0d521700-a372-4bef-828b-3d00c10adebd
	WindowsDriverUpdateEntryCollectionIID = &dcom.IID{Data1: 0x0d521700, Data2: 0xa372, Data3: 0x4bef, Data4: []byte{0x82, 0x8b, 0x3d, 0x00, 0xc1, 0x0a, 0xde, 0xbd}}
	// Syntax UUID
	WindowsDriverUpdateEntryCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0xd521700, TimeMid: 0xa372, TimeHiAndVersion: 0x4bef, ClockSeqHiAndReserved: 0x82, ClockSeqLow: 0x8b, Node: [6]uint8{0x3d, 0x0, 0xc1, 0xa, 0xde, 0xbd}}
	// Syntax ID
	WindowsDriverUpdateEntryCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: WindowsDriverUpdateEntryCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IWindowsDriverUpdateEntryCollection interface.
type WindowsDriverUpdateEntryCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) WindowsDriverUpdateEntryCollectionClient
}

type xxx_DefaultWindowsDriverUpdateEntryCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
...
func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultWindowsDriverUpdateEntryCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) WindowsDriverUpdateEntryCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultWindowsDriverUpdateEntryCollectionClient{
...
func NewWindowsDriverUpdateEntryCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (WindowsDriverUpdateEntryCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(WindowsDriverUpdateEntryCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetItemOperation) OpName() string { return "/IWindowsDriverUpdateEntryCollection/v0/Item" }
...
func (o *xxx_GetItemOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IWindowsDriverUpdateEntry}(interface))
	{
		if o.ReturnValue != nil {
			_ptr_retval := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.ReturnValue != nil {
					...
					if err := (&uamg.WindowsDriverUpdateEntry{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
...
func (o *xxx_GetItemOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// retval {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IWindowsDriverUpdateEntry}(interface))
	{
		_ptr_retval := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.ReturnValue == nil {
				o.ReturnValue = &uamg.WindowsDriverUpdateEntry{}
			}
		...
		_s_retval := func(ptr interface{}) { o.ReturnValue = *ptr.(**uamg.WindowsDriverUpdateEntry) }
...
// OpName returns the operation name of Item operation.
func (o *GetItemRequest) OpName() string { return "/IWindowsDriverUpdateEntryCollection/v0/Item" }
...
func (o *xxx_Get_NewEnumOperation) OpName() string {
	return "/IWindowsDriverUpdateEntryCollection/v0/_NewEnum"
}
...
// OpName returns the operation name of _NewEnum operation.
func (o *Get_NewEnumRequest) OpName() string {
	return "/IWindowsDriverUpdateEntryCollection/v0/_NewEnum"
}
...
func (o *xxx_GetCountOperation) OpName() string {
	return "/IWindowsDriverUpdateEntryCollection/v0/Count"
}
...
// OpName returns the operation name of Count operation.
func (o *GetCountRequest) OpName() string { return "/IWindowsDriverUpdateEntryCollection/v0/Count" }
