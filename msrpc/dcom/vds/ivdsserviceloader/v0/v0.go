...
func (o *LoadServiceRequest) xxx_ToOp(ctx context.Context) *xxx_LoadServiceOperation {
	if o == nil {
		return &xxx_LoadServiceOperation{}
	}
	return &xxx_LoadServiceOperation{
		This:        o.This,
...
func (o *LoadServiceResponse) xxx_ToOp(ctx context.Context) *xxx_LoadServiceOperation {
	if o == nil {
		return &xxx_LoadServiceOperation{}
	}
	return &xxx_LoadServiceOperation{
