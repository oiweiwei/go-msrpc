...
// OpName returns the operation name of GetProperties2 operation.
func (o *GetProperties2Request) OpName() string { return "/IVdsDisk3/v0/GetProperties2" }
...
// OpNum returns the operation number of QueryFreeExtents operation.
func (o *xxx_QueryFreeExtentsOperation) OpNum() int { return 4 }

// OpName returns the operation name of QueryFreeExtents operation.
...
// MakeQueryFreeExtentsRequest build a response structure from the given request structure.
func (o *QueryFreeExtentsRequest) MakeResponse() *QueryFreeExtentsResponse {
	return &QueryFreeExtentsResponse{}
}

// OpNum returns the operation number of QueryFreeExtents operation.
func (o *QueryFreeExtentsRequest) OpNum() int { return 4 }

// OpName returns the operation name of QueryFreeExtents operation.
func (o *QueryFreeExtentsRequest) OpName() string { return "/IVdsDisk3/v0/QueryFreeExtents" }
