...
type xxx_NextOperation struct {
	...
	Entries []*urlmon.Moniker `idl:"name:rgelt;size_is:(celt)" json:"entries"`
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1)[dim:0,size_is=celt]*(1))(2:{alias=IMoniker}(interface))
	{
		...
		for i1 := range o.Entries {
			...
			_s_rgelt := func(ptr interface{}) { o.Entries[i1] = *ptr.(**urlmon.Moniker) }
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumMoniker/v0/Next" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumMoniker/v0/Skip" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumMoniker/v0/Reset" }
...
type xxx_CloneOperation struct {
	This   *dcom.ORPCThis      `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat      `idl:"name:That" json:"that"`
	Enum   *urlmon.EnumMoniker `idl:"name:ppenum" json:"enum"`
	Return int32               `idl:"name:Return" json:"return"`
}
...
func (o *xxx_CloneOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumMoniker}(interface))
	{
		...
		_s_ppenum := func(ptr interface{}) { o.Enum = *ptr.(**urlmon.EnumMoniker) }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumMoniker/v0/Clone" }
