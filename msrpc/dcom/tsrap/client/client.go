...
import (
	...
	imanagetelnetsessions "github.com/oiweiwei/go-msrpc/msrpc/dcom/tsrap/imanagetelnetsessions/v0"
...
var (
	...
	_ = imanagetelnetsessions.GoPackage
)
...
type Client interface {
	...
	ManageTelnetSessions() imanagetelnetsessions.ManageTelnetSessionsClient
...
func (o *xxx_DefaultClient) ManageTelnetSessions() imanagetelnetsessions.ManageTelnetSessionsClient {
	return o.manageTelnetSessions
}

func NewClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (Client, error) {

	opts = append(opts,
		dcerpc.WithAbstractSyntax(imanagetelnetsessions.ManageTelnetSessionsSyntaxV0_0),
	...
	manageTelnetSessionsSubConn, err := sub.SubConn(ctx, imanagetelnetsessions.ManageTelnetSessionsSyntaxV0_0)
	if err != nil {
		// XXX: use main subconnection as a last resort
		// it was noticed that we can reuse the main connection for dcom interfaces
		manageTelnetSessionsSubConn = sub
	}

	o.manageTelnetSessions, err = imanagetelnetsessions.NewManageTelnetSessionsClient(ctx, manageTelnetSessionsSubConn, append(opts, dcerpc.WithNoBind(manageTelnetSessionsSubConn))...)
	return o, nil
}
...
func (o *xxx_DefaultClient) IPID(ctx context.Context, ipid *dcom.IPID) Client {
	...
	return &xxx_DefaultClient{
		...
		manageTelnetSessions: o.manageTelnetSessions.IPID(ctx, ipid),
		cc:                   o.cc,
	}
}
