...
type InjectNTMSMediaRequest struct {
	...
	//
	// The lpInjectOperation identifier received in an NTMS_INJECT_START operation is used
	// only in a NTMS_INJECT_STOP operation. The lpInjectOperation identifier received in
	// a NTMS_INJECT_STARTMANY operation is used only in the NTMS_INJECT_STOP and NTMS_INJECT_RETRACT
	// operations.
	InjectOperation *dtyp.GUID `idl:"name:lpInjectOperation" json:"inject_operation"`
