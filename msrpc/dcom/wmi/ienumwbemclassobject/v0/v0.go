...
func (o *NextAsyncRequest) xxx_ToOp(ctx context.Context) *xxx_NextAsyncOperation {
	if o == nil {
		return &xxx_NextAsyncOperation{}
	}
	return &xxx_NextAsyncOperation{
		This:  o.This,
		Count: o.Count,
...
func (o *NextAsyncResponse) xxx_ToOp(ctx context.Context) *xxx_NextAsyncOperation {
	if o == nil {
		return &xxx_NextAsyncOperation{}
	}
	return &xxx_NextAsyncOperation{
