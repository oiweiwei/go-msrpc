...
// OpNum returns the operation number of Reset operation.
func (o *ResetRequest) OpNum() int { return 3 }

// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumWbemClassObject/v0/Reset" }
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumWbemClassObject/v0/Next" }
...
// OpNum returns the operation number of NextAsync operation.
func (o *xxx_NextAsyncOperation) OpNum() int { return 5 }

// OpName returns the operation name of NextAsync operation.
...
// MakeNextAsyncRequest build a response structure from the given request structure.
func (o *NextAsyncRequest) MakeResponse() *NextAsyncResponse {
	return &NextAsyncResponse{}
}

// OpNum returns the operation number of NextAsync operation.
func (o *NextAsyncRequest) OpNum() int { return 5 }

// OpName returns the operation name of NextAsync operation.
func (o *NextAsyncRequest) OpName() string { return "/IEnumWbemClassObject/v0/NextAsync" }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumWbemClassObject/v0/Clone" }
...
// OpNum returns the operation number of Skip operation.
func (o *SkipRequest) OpNum() int { return 7 }

// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumWbemClassObject/v0/Skip" }
