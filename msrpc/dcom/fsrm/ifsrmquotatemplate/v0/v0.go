...
// OpNum returns the operation number of Name operation.
func (o *GetNameRequest) OpNum() int { return 22 }

// OpName returns the operation name of Name operation.
func (o *GetNameRequest) OpName() string { return "/IFsrmQuotaTemplate/v0/Name" }
...
// OpNum returns the operation number of Name operation.
func (o *SetNameRequest) OpNum() int { return 23 }

// OpName returns the operation name of Name operation.
func (o *SetNameRequest) OpName() string { return "/IFsrmQuotaTemplate/v0/Name" }
...
// OpNum returns the operation number of CopyTemplate operation.
func (o *CopyTemplateRequest) OpNum() int { return 24 }

// OpName returns the operation name of CopyTemplate operation.
func (o *CopyTemplateRequest) OpName() string { return "/IFsrmQuotaTemplate/v0/CopyTemplate" }
...
// OpNum returns the operation number of CommitAndUpdateDerived operation.
func (o *CommitAndUpdateDerivedRequest) OpNum() int { return 25 }
