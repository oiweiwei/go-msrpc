...
// OpName returns the operation name of Name operation.
func (o *GetNameRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Name" }
...
// OpNum returns the operation number of Name operation.
func (o *SetNameRequest) OpNum() int { return 8 }

// OpName returns the operation name of Name operation.
func (o *SetNameRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Name" }
...
// OpName returns the operation name of Type operation.
func (o *GetTypeRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Type" }
...
// OpName returns the operation name of Type operation.
func (o *SetTypeRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Type" }
...
// OpNum returns the operation number of Value operation.
func (o *GetValueRequest) OpNum() int { return 11 }

// OpName returns the operation name of Value operation.
func (o *GetValueRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Value" }
...
// OpNum returns the operation number of Value operation.
func (o *SetValueRequest) OpNum() int { return 12 }

// OpName returns the operation name of Value operation.
func (o *SetValueRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Value" }
...
// OpName returns the operation name of Delete operation.
func (o *DeleteRequest) OpName() string { return "/IFsrmPropertyCondition/v1/Delete" }
