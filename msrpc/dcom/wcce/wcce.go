...
type CATransportProperty struct {
	...
	// CATRANSPROP (section 2.2.2.3) structure that is transferred in the CERTTRANSBLOB
	// (section 2.2.2.2) structure. Little-endian encoding format MUST be used.
	...
	//	+-------+----------------------------------------------------------------------------------+
	//
	// propFlags (2 bytes): These 2 bytes indicate the value of the propFlags field of the
	// first CATRANSPROP (section 2.2.2.3) structure that is transferred in the CERTTRANSBLOB
	// (section 2.2.2.2) structure. Little-endian encoding format MUST be used.
	...
	// CERTTRANSBLOB (section 2.2.2.2) structure. Little-endian encoding format MUST be
	// used. The value of this field indicates an offset from the beginning of the pb field
	// to where the data value for this property can be found in the byte array. The value
	// of this field must be DWORD-aligned.
