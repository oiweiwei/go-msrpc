...
type GetDependenciesResponse struct {
	...
	//
	// A DependencyList element can specify policies, schedules, calendars, and conditional
	// policy events. The content of the structure that is returned by this method is determined
	// by the value of the enumObject parameter.
	DependencyList *oaut.String `idl:"name:pbstrDependencyList" json:"dependency_list"`
