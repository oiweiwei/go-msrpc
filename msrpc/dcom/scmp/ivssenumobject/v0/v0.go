...
var (
	...
	EnumObjectIID = &dcom.IID{Data1: 0xae1c7110, Data2: 0x2f60, Data3: 0x11d3, Data4: []byte{0x8a, 0x39, 0x00, 0xc0, 0x4f, 0x72, 0xd8, 0xe3}}
	// Syntax UUID
	EnumObjectSyntaxUUID = &uuid.UUID{TimeLow: 0xae1c7110, TimeMid: 0x2f60, TimeHiAndVersion: 0x11d3, ClockSeqHiAndReserved: 0x8a, ClockSeqLow: 0x39, Node: [6]uint8{0x0, 0xc0, 0x4f, 0x72, 0xd8, 0xe3}}
	// Syntax ID
...
type xxx_NextOperation struct {
	...
	Entries []*scmp.ObjectProperty `idl:"name:rgelt;size_is:(celt);length_is:(pceltFetched)" json:"entries"`
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=VSS_OBJECT_PROP}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
		...
		for i1 := range o.Entries {
			...
			if o.Entries[i1] != nil {
				...
				if err := (&scmp.ObjectProperty{}).MarshalNDR(ctx, w); err != nil {
					return err
				}
			}
		}
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=VSS_OBJECT_PROP}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
		...
		o.Entries = make([]*scmp.ObjectProperty, sizeInfo[0])
		for i1 := range o.Entries {
			i1 := i1
			if o.Entries[i1] == nil {
				o.Entries[i1] = &scmp.ObjectProperty{}
			}
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IVssEnumObject/v0/Next" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IVssEnumObject/v0/Skip" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IVssEnumObject/v0/Reset" }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IVssEnumObject/v0/Clone" }
