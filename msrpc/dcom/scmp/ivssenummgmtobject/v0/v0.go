...
func (o *xxx_NextOperation) OpName() string { return "/IVssEnumMgmtObject/v0/Next" }
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=VSS_MGMT_OBJECT_PROP}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IVssEnumMgmtObject/v0/Next" }
...
func (o *xxx_SkipOperation) OpName() string { return "/IVssEnumMgmtObject/v0/Skip" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IVssEnumMgmtObject/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IVssEnumMgmtObject/v0/Reset" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IVssEnumMgmtObject/v0/Reset" }
...
func (o *xxx_CloneOperation) OpName() string { return "/IVssEnumMgmtObject/v0/Clone" }
...
func (o *xxx_CloneOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	...
	// ppenum {in, out} (1:{pointer=ref}*(2)*(1))(2:{alias=IVssEnumMgmtObject}(interface))
	{
		if o.Enum != nil {
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IVssEnumMgmtObject/v0/Clone" }
