...
var (
	// IMSMQQueueInfos4 interface identifier eba96b22-2168-11d3-898c-00e02c074f6b
	QueueInfos4IID = &dcom.IID{Data1: 0xeba96b22, Data2: 0x2168, Data3: 0x11d3, Data4: []byte{0x89, 0x8c, 0x00, 0xe0, 0x2c, 0x07, 0x4f, 0x6b}}
	// Syntax UUID
	QueueInfos4SyntaxUUID = &uuid.UUID{TimeLow: 0xeba96b22, TimeMid: 0x2168, TimeHiAndVersion: 0x11d3, ClockSeqHiAndReserved: 0x89, ClockSeqLow: 0x8c, Node: [6]uint8{0x0, 0xe0, 0x2c, 0x7, 0x4f, 0x6b}}
	// Syntax ID
	QueueInfos4SyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: QueueInfos4SyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IMSMQQueueInfos4 interface.
type QueueInfos4Client interface {
	...
	IPID(context.Context, *dcom.IPID) QueueInfos4Client
}

type xxx_DefaultQueueInfos4Client struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultQueueInfos4Client) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultQueueInfos4Client) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
...
func (o *xxx_DefaultQueueInfos4Client) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultQueueInfos4Client) GetProperties(ctx context.Context, in *GetPropertiesRequest, opts ...dcerpc.CallOption) (*GetPropertiesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultQueueInfos4Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultQueueInfos4Client) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultQueueInfos4Client) IPID(ctx context.Context, ipid *dcom.IPID) QueueInfos4Client {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultQueueInfos4Client{
...
func NewQueueInfos4Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (QueueInfos4Client, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(QueueInfos4SyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_ResetOperation) OpName() string { return "/IMSMQQueueInfos4/v0/Reset" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IMSMQQueueInfos4/v0/Reset" }
...
func (o *xxx_NextOperation) OpName() string { return "/IMSMQQueueInfos4/v0/Next" }
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppqinfoNext {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IMSMQQueueInfo4}(interface))
	{
		if o.Next != nil {
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppqinfoNext {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IMSMQQueueInfo4}(interface))
	{
		...
		_s_ppqinfoNext := func(ptr interface{}) { o.Next = *ptr.(**mqac.QueueInfo4) }
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IMSMQQueueInfos4/v0/Next" }
...
func (o *xxx_GetPropertiesOperation) OpName() string { return "/IMSMQQueueInfos4/v0/Properties" }
...
// OpName returns the operation name of Properties operation.
func (o *GetPropertiesRequest) OpName() string { return "/IMSMQQueueInfos4/v0/Properties" }
