...
var (
	...
	ImsmqQuery3IID = &dcom.IID{Data1: 0xeba96b19, Data2: 0x2168, Data3: 0x11d3, Data4: []byte{0x89, 0x8c, 0x00, 0xe0, 0x2c, 0x07, 0x4f, 0x6b}}
	// Syntax UUID
	ImsmqQuery3SyntaxUUID = &uuid.UUID{TimeLow: 0xeba96b19, TimeMid: 0x2168, TimeHiAndVersion: 0x11d3, ClockSeqHiAndReserved: 0x89, ClockSeqLow: 0x8c, Node: [6]uint8{0x0, 0xe0, 0x2c, 0x7, 0x4f, 0x6b}}
	// Syntax ID
	ImsmqQuery3SyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: ImsmqQuery3SyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IMSMQQuery3 interface.
type ImsmqQuery3Client interface {
	...
	IPID(context.Context, *dcom.IPID) ImsmqQuery3Client
}

type xxx_DefaultImsmqQuery3Client struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultImsmqQuery3Client) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultImsmqQuery3Client) LookupQueueV2(ctx context.Context, in *LookupQueueV2Request, opts ...dcerpc.CallOption) (*LookupQueueV2Response, error) {
...
func (o *xxx_DefaultImsmqQuery3Client) GetProperties(ctx context.Context, in *GetPropertiesRequest, opts ...dcerpc.CallOption) (*GetPropertiesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultImsmqQuery3Client) LookupQueue(ctx context.Context, in *LookupQueueRequest, opts ...dcerpc.CallOption) (*LookupQueueResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultImsmqQuery3Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultImsmqQuery3Client) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultImsmqQuery3Client) IPID(ctx context.Context, ipid *dcom.IPID) ImsmqQuery3Client {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultImsmqQuery3Client{
...
func NewImsmqQuery3Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (ImsmqQuery3Client, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(ImsmqQuery3SyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_LookupQueueV2Operation struct {
	...
	Ppqinfos            *mqac.ImsmqQueueInfos3 `idl:"name:ppqinfos" json:"ppqinfos"`
		...
		if o.Ppqinfos != nil {
			_ptr_ppqinfos := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Ppqinfos != nil {
					...
					if err := (&mqac.ImsmqQueueInfos3{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
...
func (o *xxx_LookupQueueV2Operation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppqinfos {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IMSMQQueueInfos3}(interface))
	{
		_ptr_ppqinfos := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.Ppqinfos == nil {
				o.Ppqinfos = &mqac.ImsmqQueueInfos3{}
			}
		...
		_s_ppqinfos := func(ptr interface{}) { o.Ppqinfos = *ptr.(**mqac.ImsmqQueueInfos3) }
