...
var (
	...
	TransactionDispenser2IID = &dcom.IID{Data1: 0xeba96b11, Data2: 0x2168, Data3: 0x11d3, Data4: []byte{0x89, 0x8c, 0x00, 0xe0, 0x2c, 0x07, 0x4f, 0x6b}}
	// Syntax UUID
	TransactionDispenser2SyntaxUUID = &uuid.UUID{TimeLow: 0xeba96b11, TimeMid: 0x2168, TimeHiAndVersion: 0x11d3, ClockSeqHiAndReserved: 0x89, ClockSeqLow: 0x8c, Node: [6]uint8{0x0, 0xe0, 0x2c, 0x7, 0x4f, 0x6b}}
	// Syntax ID
	TransactionDispenser2SyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: TransactionDispenser2SyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IMSMQTransactionDispenser2 interface.
type TransactionDispenser2Client interface {
	...
	IPID(context.Context, *dcom.IPID) TransactionDispenser2Client
}

type xxx_DefaultTransactionDispenser2Client struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultTransactionDispenser2Client) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultTransactionDispenser2Client) BeginTransaction(ctx context.Context, in *BeginTransactionRequest, opts ...dcerpc.CallOption) (*BeginTransactionResponse, error) {
...
func (o *xxx_DefaultTransactionDispenser2Client) GetProperties(ctx context.Context, in *GetPropertiesRequest, opts ...dcerpc.CallOption) (*GetPropertiesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultTransactionDispenser2Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultTransactionDispenser2Client) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultTransactionDispenser2Client) IPID(ctx context.Context, ipid *dcom.IPID) TransactionDispenser2Client {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultTransactionDispenser2Client{
...
func NewTransactionDispenser2Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (TransactionDispenser2Client, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(TransactionDispenser2SyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
// OpName returns the operation name of Properties operation.
func (o *GetPropertiesRequest) OpName() string { return "/IMSMQTransactionDispenser2/v0/Properties" }
