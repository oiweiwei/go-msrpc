...
func (o *xxx_BeginTransactionOperation) OpName() string {
	return "/IMSMQCoordinatedTransactionDispenser2/v0/BeginTransaction"
}
...
func (o *xxx_GetPropertiesOperation) OpName() string {
	return "/IMSMQCoordinatedTransactionDispenser2/v0/Properties"
}
...
// OpName returns the operation name of Properties operation.
func (o *GetPropertiesRequest) OpName() string {
	return "/IMSMQCoordinatedTransactionDispenser2/v0/Properties"
}
