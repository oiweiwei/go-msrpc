...
var (
	...
	ImsmqTransactionDispenser3IID = &dcom.IID{Data1: 0xeba96b15, Data2: 0x2168, Data3: 0x11d3, Data4: []byte{0x89, 0x8c, 0x00, 0xe0, 0x2c, 0x07, 0x4f, 0x6b}}
	// Syntax UUID
	ImsmqTransactionDispenser3SyntaxUUID = &uuid.UUID{TimeLow: 0xeba96b15, TimeMid: 0x2168, TimeHiAndVersion: 0x11d3, ClockSeqHiAndReserved: 0x89, ClockSeqLow: 0x8c, Node: [6]uint8{0x0, 0xe0, 0x2c, 0x7, 0x4f, 0x6b}}
	// Syntax ID
	ImsmqTransactionDispenser3SyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: ImsmqTransactionDispenser3SyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IMSMQTransactionDispenser3 interface.
type ImsmqTransactionDispenser3Client interface {
	...
	IPID(context.Context, *dcom.IPID) ImsmqTransactionDispenser3Client
}

type xxx_DefaultImsmqTransactionDispenser3Client struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultImsmqTransactionDispenser3Client) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultImsmqTransactionDispenser3Client) BeginTransaction(ctx context.Context, in *BeginTransactionRequest, opts ...dcerpc.CallOption) (*BeginTransactionResponse, error) {
...
func (o *xxx_DefaultImsmqTransactionDispenser3Client) GetProperties(ctx context.Context, in *GetPropertiesRequest, opts ...dcerpc.CallOption) (*GetPropertiesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultImsmqTransactionDispenser3Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultImsmqTransactionDispenser3Client) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultImsmqTransactionDispenser3Client) IPID(ctx context.Context, ipid *dcom.IPID) ImsmqTransactionDispenser3Client {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultImsmqTransactionDispenser3Client{
...
func NewImsmqTransactionDispenser3Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (ImsmqTransactionDispenser3Client, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(ImsmqTransactionDispenser3SyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_BeginTransactionOperation) OpName() string {
	return "/IMSMQTransactionDispenser3/v0/BeginTransaction"
}
...
func (o *xxx_GetPropertiesOperation) OpName() string {
	return "/IMSMQTransactionDispenser3/v0/Properties"
}
