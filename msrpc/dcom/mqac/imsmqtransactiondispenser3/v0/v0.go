...
type xxx_DefaultTransactionDispenser3Client struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultTransactionDispenser3Client) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultTransactionDispenser3Client) BeginTransaction(ctx context.Context, in *BeginTransactionRequest, opts ...dcerpc.CallOption) (*BeginTransactionResponse, error) {
...
func (o *xxx_DefaultTransactionDispenser3Client) GetProperties(ctx context.Context, in *GetPropertiesRequest, opts ...dcerpc.CallOption) (*GetPropertiesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultTransactionDispenser3Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultTransactionDispenser3Client) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultTransactionDispenser3Client) IPID(ctx context.Context, ipid *dcom.IPID) TransactionDispenser3Client {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultTransactionDispenser3Client{
...
func NewTransactionDispenser3Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (TransactionDispenser3Client, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(TransactionDispenser3SyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
// OpName returns the operation name of Properties operation.
func (o *GetPropertiesRequest) OpName() string { return "/IMSMQTransactionDispenser3/v0/Properties" }
