...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumConnections/v0/Next" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumConnections/v0/Skip" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumConnections/v0/Reset" }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumConnections/v0/Clone" }
