...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IMSMQQueueInfos2/v0/Reset" }
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IMSMQQueueInfos2/v0/Next" }
...
// OpName returns the operation name of Properties operation.
func (o *GetPropertiesRequest) OpName() string { return "/IMSMQQueueInfos2/v0/Properties" }
