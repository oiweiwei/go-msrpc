...
type _NewEnumResponse struct {
	// That: ORPCTHAT structure that is used to return ORPC extension data to the client.
	That *dcom.ORPCThat `idl:"name:That" json:"that"`
	// ppunk: The ppunk output parameter MUST be set to an IUnknown pointer to a standard
	// OLE automation enumerator that can be used to enumerate the VariantCollection instance
	// variable elements.
	Unknown *dcom.Unknown `idl:"name:ppunk" json:"unknown"`
