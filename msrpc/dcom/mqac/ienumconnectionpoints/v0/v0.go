...
var (
	// IEnumConnectionPoints interface identifier b196b285-bab4-101a-b69c-00aa00341d07
	EnumConnectionPointsIID = &dcom.IID{Data1: 0xb196b285, Data2: 0xbab4, Data3: 0x101a, Data4: []byte{0xb6, 0x9c, 0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07}}
	// Syntax UUID
	EnumConnectionPointsSyntaxUUID = &uuid.UUID{TimeLow: 0xb196b285, TimeMid: 0xbab4, TimeHiAndVersion: 0x101a, ClockSeqHiAndReserved: 0xb6, ClockSeqLow: 0x9c, Node: [6]uint8{0x0, 0xaa, 0x0, 0x34, 0x1d, 0x7}}
	// Syntax ID
	EnumConnectionPointsSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: EnumConnectionPointsSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IEnumConnectionPoints interface.
type EnumConnectionPointsClient interface {
	...
	IPID(context.Context, *dcom.IPID) EnumConnectionPointsClient
}

type xxx_DefaultEnumConnectionPointsClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultEnumConnectionPointsClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultEnumConnectionPointsClient) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
...
func (o *xxx_DefaultEnumConnectionPointsClient) Skip(ctx context.Context, in *SkipRequest, opts ...dcerpc.CallOption) (*SkipResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumConnectionPointsClient) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumConnectionPointsClient) Clone(ctx context.Context, in *CloneRequest, opts ...dcerpc.CallOption) (*CloneResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumConnectionPointsClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultEnumConnectionPointsClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultEnumConnectionPointsClient) IPID(ctx context.Context, ipid *dcom.IPID) EnumConnectionPointsClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultEnumConnectionPointsClient{
...
func NewEnumConnectionPointsClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (EnumConnectionPointsClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(EnumConnectionPointsSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumConnectionPoints/v0/Next" }
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppCP {out} (1:{pointer=ref}*(1))(2:{alias=LPCONNECTIONPOINT}[dim:0,size_is=cConnections,length_is=pcFetched]*(1))(3:{alias=IConnectionPoint}(interface))
	{
...
func (o *NextRequest) MakeResponse() *NextResponse {
	...
	return &NextResponse{
		ConnectionsCount: o.ConnectionsCount,
	}
}
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumConnectionPoints/v0/Next" }
...
func (o *xxx_SkipOperation) OpName() string { return "/IEnumConnectionPoints/v0/Skip" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumConnectionPoints/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IEnumConnectionPoints/v0/Reset" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumConnectionPoints/v0/Reset" }
...
func (o *xxx_CloneOperation) OpName() string { return "/IEnumConnectionPoints/v0/Clone" }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumConnectionPoints/v0/Clone" }
