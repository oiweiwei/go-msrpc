...
ifeq ($(LOCAL),1)
	DOCKER_RUNNER := ../midl-gen-go/bin/midl-gen-go generate \
		--pkg "github.com/oiweiwei/go-msrpc/msrpc/" \
		-I ./idl \
		-I ./idl/h \
		--output ./msrpc/ \
		--msdn-openspecs-indexer-file ./msdn/index.yaml \
		$(DOCKER_RUNNER_FLAGS) \
		--msdn-openspecs-indexer-extra-file ./msdn/extra.yaml \
		--msdn-openspecs-cache-dir ./msdn/.cache/
endif
...
.PHONY: clean
clean:
	find ./msrpc -type f -exec sh -c 'head -n1 "$$1" | grep -qi "Code generated by github.com/oiweiwei/midl-gen-go. DO NOT EDIT."' _ {} \; -print -delete
	find ./msrpc -type d -empty -delete
